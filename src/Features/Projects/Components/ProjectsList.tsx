...
export const formatTimeStamp = (t : number) =>{
    return formatDistanceToNow( new Date(t),{
        addSuffix:true
    })
}
...
const ProjectsList = ({ onViewAll } : Props)  => {
  ...
  return (
    <div className="flex flex-col gap-4">
       { mostRecent ?  <ContinueCards data={mostRecent} /> : null}
        { rest.length > 0 && (
            <div className="flex flex-col gap-2">
                <div className=" flex items-center justify-between gap-2">
                    ...
                    <button onClick={onViewAll} className="flex items-center gap-2 text-muted-foreground text-xs hover:text-muted-foreground transition-colors">
                        <span>View all</span>
